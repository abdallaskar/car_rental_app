...
function createCard(car) {
  return `
    <div class="col-md-4">
      ...
      <div>
      <h5 class="card-title">${car.brand} ${car.model} ${car.type} ${car.booked ? "<span style='color: red;'>●</span>" : " <span style = 'color: green;' >●</span>"}</h5>
  ...
  return `
    <div class="modal fade" id="${car.car_id}" tabindex="-1" aria-labelledby="cardModaLabel" aria-hidden="true">
      ...
      <div class="row g-3 align-items-center">
        ...
        <p><strong>This car is :</strong>${car.booked ? " NOT Avalible" : " Avalible"}</p>
